      ...
      >
        ...
        <div className="contact__data">
          <div className="contact__data__description">
            <h4>Have a project in mind? Contact me.</h4>
 
            <div>
              <p>
                <strong>Address:</strong> 616 Ndege Road, Karen
              </p>
              <p>
                <strong>Email:</strong> babrakoskei@gmail.com
              </p>
              <p>
                <strong>Website:</strong> www.babrakoskei.com
              </p>
            </div>
          </div>
